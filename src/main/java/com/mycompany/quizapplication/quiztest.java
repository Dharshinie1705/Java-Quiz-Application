...
public class quiztest extends JFrame implements  ActionListener{
	...
	void set() {
		...
		if (current == 7) {
			label.setText("<html>Que8:  What is the access modifier for a member of a class that is accessible in all other classes in the same package?</html>");
